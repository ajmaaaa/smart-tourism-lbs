...
const fallbackImages = {
  'masjid-raya-sultan-riau': '/images/masjid.jpg',
  'balai-adat': '/images/balai-adat.jpg',
  'makam-raja-ali-haji': '/images/makam.jpg',
  'benteng-bukit-kursi': '/images/benteng.jpg',
  'istana-kantor': '/images/penyengat-about.jpg',
  'pelabuhan-penyengat': '/images/gallery-dermaga.jpg'
}
          ...
          <article key={dest.id} className="destination-card">
            <div className="destination-card__visual image-visual">
              <img
                ...
                alt={dest.name}
                loading="lazy"
                onError={(e) => { e.currentTarget.src = fallbackImages[dest.id] || '/images/penyengat-about.jpg' }}
              />
